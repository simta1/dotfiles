return {
    ...
    config = function(_, opts)
        ...
        local bg_color = "#191a21"
        local yellow_bright = "#F1FA8C"
        local yellow_dim = "#8d915e"
        local cyan_bright = "#8BE9FD"

        -- hl(0, "BufferTabpageFill", { bg = "NONE" })
        hl(0, "BufferTabpageFill", { bg = bg_color })

        hl(0, "BufferCurrent", { fg = cyan_bright, bg = bg_color, bold = true })
        hl(0, "BufferCurrentIndex", { fg = cyan_bright, bg = bg_color })
        hl(0, "BufferCurrentIcon", { fg = cyan_bright, bg = bg_color })
        hl(0, "BufferCurrentSign", { fg = cyan_bright, bg = bg_color })
        hl(0, "BufferCurrentTarget", { fg = cyan_bright, bg = bg_color })
        hl(0, "BufferCurrentBtn", { fg = cyan_bright, bg = bg_color })

        hl(0, "BufferCurrentMod", { fg = yellow_bright, bg = bg_color, bold = true })
        hl(0, "BufferInactiveMod", { fg = yellow_dim, bg = bg_color })
